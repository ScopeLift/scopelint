...
fn test_check_proj1_all_findings() {
    ...
    let expected_findings = [
        ...
        "Invalid src method name in ./src/Counter.sol on line 28: anotherVar",
        "Invalid src method name in ./src/Counter.sol on line 23: i",
        "Invalid src method name in ./src/Counter.sol on line 53: internalShouldHaveLeadingUnderscore",
        "Invalid src method name in ./src/Counter.sol on line 21: localAddr",
        "Invalid src method name in ./src/Counter.sol on line 20: localVar",
        "Invalid src method name in ./src/Counter.sol on line 15: newNumber",
        "Invalid src method name in ./src/Counter.sol on line 19: param1",
        "Invalid src method name in ./src/Counter.sol on line 19: param2",
        "Invalid src method name in ./src/Counter.sol on line 55: privateShouldHaveLeadingUnderscore",
        "Invalid src method name in ./src/Counter.sol on line 19: result",
        "Invalid src method name in ./src/Counter.sol on line 24: temp",
        "Invalid src method name in ./src/CounterIgnored3.sol on line 20: newNumber",
        "Invalid src method name in ./src/CounterIgnored3.sol on line 41: someImportantData",
        "Invalid src method name in ./src/CounterIgnored3.sol on line 50: someImportantData",
        "Invalid src method name in ./src/CounterIgnored3.sol on line 40: someImportantNumber",
        "Invalid src method name in ./src/CounterIgnored3.sol on line 49: someImportantNumber",
        "Invalid src method name in ./src/CounterIgnored3.sol on line 39: someImportantUser",
        "Invalid src method name in ./src/CounterIgnored3.sol on line 48: someImportantUser",
...
fn test_check_proj2_no_findings() {
    ...
    let expected_findings = [
        "Invalid src method name in ./src/Counter.sol on line 13: newNumber",
        "error: Convention checks failed, see details above",
        "error: Formatting validation failed, run `scopelint fmt` to fix",
        "",
    ];
