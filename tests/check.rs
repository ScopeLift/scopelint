...
fn test_check_proj1_all_findings() {
    ...
    let expected_findings = [
        ...
        "Invalid test name in ./test/Counter.t.sol on line 17: testIncrementBadName",
        ...
        "Invalid variable name in ./test/Counter.t.sol on line 32: Local variable 'x' should have underscore prefix",
        "Invalid variable name in ./test/Counter.t.sol on line 22: Parameter 'x' should have underscore prefix",
        "Invalid variable name in ./test/Counter.t.sol on line 10: Transient state variable 'reentrancyFlag' should be prefixed with 't_'",
