...
fn test_check_proj1_all_findings() {
    ...
    let expected_findings = [
        ...
        "Invalid src method name in ./src/Counter.sol on line 25: internalShouldHaveLeadingUnderscore",
        "Invalid src method name in ./src/Counter.sol on line 27: privateShouldHaveLeadingUnderscore",
        ...
        "Invalid variable name in ./src/Counter.sol on line 17: Parameter 'newNumber' should have underscore prefix",
        "Invalid variable name in ./src/Counter.sol on line 32: Parameter 'owner' should have underscore prefix",
        "Invalid variable name in ./src/Counter.sol on line 32: Parameter 'spender' should have underscore prefix",
        "Invalid variable name in ./src/Counter.sol on line 32: Parameter 'value' should have underscore prefix",
        ...
        "Invalid event name in ./src/Counter.sol on line 38: Event 'AnotherInvalidEvent' should be prefixed with 'Counter_'",
        "Invalid event name in ./src/Counter.sol on line 37: Event 'InvalidEvent' should be prefixed with 'Counter_'",
